...
<html lang="en">
<head>
    <link rel="icon" href="../../img/direpr.png" type="image/png">
    ...
    <div class="body">
        <div class="menu-barra" id="menu-barra">
            ...
            <a href="admin_page.php" class="logo" id="logo">
                ...
                <label id="ie">Direpro Admin</label>
            </a>
            <div class="opciones">
                <a class="opcion" href="admin/tipos_empresa.php" title="Suscripciones" target="cuerpo"><span><i class="fa-solid fa-clipboard"></i></span> <h2 class="letra"> Tipos de Empresa</h2></a>
                <a class="opcion" href="admin/sector.php" title="sector" target="cuerpo"><span><i class="fa-brands fa-servicestack"></i></span>       <h2 class="letra">sector

                </h2></a>
                <a class="opcion" href="admin/inscripciones.php" title="Proveedores" target="cuerpo"><span><i class="fa-brands fa-servicestack"></i></span>       <h2 class="letra">Inscripciones</h2></a>
            ...
            <div class="usuario">
                ...
                <a class="salir" href="../php/cerrar_sesion.php" title="Cerrar Sesión"><span><i class="fa-solid fa-right-from-bracket"></i></span></a>
            </div>
        </div>
        <iframe name="cuerpo" src="admin/vista_admin.php" frameborder="0"></iframe>
    </div>
   <script>
       /* window,alert("hola") */
