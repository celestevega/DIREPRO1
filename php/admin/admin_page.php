...
<body>
    <div class="body">
        <div class="menu-barra" id="menu-barra">
            ...
            <div class="opciones">
                <a class="opcion" href="dashboard.php" title="dashboard" target="cuerpo"><span><i class="fa-solid fa-chart-line"></i></span> <h2 class="letra">Dashboard</h2></a>
                ...
                <a class="opcion" href="tipos_empresa.php" title="Suscripciones" target="cuerpo"><span><i class="fa-solid fa-clipboard"></i></span> <h2 class="letra"> Tipos de Empresa</h2></a>
                <a class="opcion" href="sector.php" title="sector" target="cuerpo"><span><i class="fa-brands fa-servicestack"></i></span>       <h2 class="letra">sector

                </h2></a>
                <a class="opcion" href="inscripciones.php" title="Proveedores" target="cuerpo"><span><i class="fa-brands fa-servicestack"></i></span>       <h2 class="letra">Inscripciones</h2></a>
        ...
        <iframe name="cuerpo" src="vista_admin.php" frameborder="0"></iframe>
    </div>
   <script>
       /* window,alert("hola") */
