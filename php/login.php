...
<head>
    <link rel="icon" type="image/png" href="../img/direpr.png">
...
<body>
    <section class="cuerpo">
        <header class="head">
            <div class="logo">
                <img src="../img/direpr.png" alt="buho">
                <label>DIREPRO</label>
            </div>
        </header>
        <form method="post" action="login.php" class="form_sesion">
            <div class="datos">
                <div class="" id="">
